...
(function ($) {
    ...
    // jQuery click event handler
		$('.js-show-modal1').on('click', function(e) {
			...
			$.ajax({
				...
				success: function(response) {
					...
					document.getElementById("qaddtocart").setAttribute('onclick', 'qaddtocart(' + response.cartno + ', ' + contentType + ')');
        ...
        $('.js-hide-modal1').on('click', function() {
			$(`.item-slick3`).attr('data-thumb', '');


			$('.item-slick3').removeClass('slick-current slick-active');
			$(`.item-slick3`).attr('aria-hidden', 'true');
			$(`.item-slick3`).attr('tabindex', '-1');
			$('.item-slick3').css('opacity', 0);

			$('.newitemslick31').addClass('slick-current slick-active');
			$('.newitemslick31').attr('aria-hidden', 'false');
			$('.newitemslick31').attr('tabindex', '0');
			$('.newitemslick31').css('opacity', 1);
